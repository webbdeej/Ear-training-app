...
let chooseButtons = document.getElementById("choice-buttons-div").getElementsByTagName('button');
...
let soundFiles = {'MINOR SECOND': "min-2nd.mp3", 'MAJOR SECOND': "maj-2nd.mp3",
'MINOR THIRD': "min-3rd.mp3", 'MAJOR THIRD': "maj-3rd.mp3", 'FOURTH': "perf-4th.mp3",
'DIMINISHED FIFTH': "dim-5th.mp3", 'FIFTH': "perf-5th.mp3", 'MINOR SIXTH': "min-6th.mp3",
'MAJOR SIXTH': "maj-6th.mp3", 'MINOR SEVENTH': "min-7th.mp3" ,
'MAJOR SEVENTH': "maj-7th.mp3", 'OCTAVE': "octave.mp3",
'MINOR NINTH': "min-9th.mp3", 'MAJOR NINTH':"maj-9th.mp3"
};
  ...
  let harmonicAudio = "Audio/harmonic/" + soundFiles[randomInterval];
    ...
    if (fixedRoot.selected) {
      if (ascending.selected) {
        ...
        whichOne === 0? audio.setAttribute('src', ascendAudio):
        audio.setAttribute('src', descendAudio);
      }
...
function changingRoot(randomInterval) {
  ...
  let changeAscend = "Audio/ascending/changing-root/" + assign + '-' + soundFiles[randomInterval];
